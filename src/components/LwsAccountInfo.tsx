    ...
    return (
      <div className="AccountInfoContainer">
        <div className="AccountInfoContainer-Text">
          <div className="AccountInfoContainer-Name">
            {this.props.accountName}
          </div>
          <div className="AccountInfoContainer-Role">
            {this.props.accountRole}
          </div>
        </div>
        <div className="AccountInfoContainer-Icon">
          <div className="AccountInfoContainer-Icon-Text">
            {this.props.accountFirstLetter}
          </div>
        </div>
      </div>
    );
